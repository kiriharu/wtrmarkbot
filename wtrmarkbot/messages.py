...
STARTING_MESSAGE = (
    f"Привет! Добро пожаловать в @wtrmarkbot!"
    f"\n\n"
...
routes_messages = {
    "position": dict(
        text="↕️ Выбери позицию вотермарки: ", reply_markup=watermark_position()
    ),
    "color": dict(text="🏁 Выбери цвет текста", reply_markup=colors()),
    "opacity": dict(
        text="➿ Установи прозрачность цифрой от 1 до 255 (255 непрозрачный, 1 - полностью прозрачный)",
        reply_markup=ReplyKeyboardRemove(),
    ),
    "font": dict(text="✍️ Выбери шрифт", reply_markup=fonts()),
    "fontsize": dict(
        text=f"✍️ Выбери размер шрифта (до {MAX_FONT_SIZE})",
        reply_markup=ReplyKeyboardRemove(),
    ),
    "text": dict(text=f"💬 Напиши текст вотермарки", reply_markup=ReplyKeyboardRemove()),
    "sendpic": dict(
        text="💫 Вот твоя картинка с вотермаркой. Вышло неплохо, хочешь ещё? Отправь следующую картинку!",
        reply_markup=main_menu(),
    ),
    "result_type": dict(text="🖼 Выбери формат ответа", reply_markup=result_types()),
}
